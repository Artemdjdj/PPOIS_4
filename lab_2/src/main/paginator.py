...
class Paginator:
    def __init__(self, button_prev: QPushButton, button_first: QPushButton, button_current: QPushButton,
                 button_last: QPushButton, button_next: QPushButton, combobox_pagination: QComboBox,
                 table_of_recording: QTableWidget) -> None:
    ...
    def paginate(self):
        if self.__count_pages == 1:
            ...
            if self.__current_page == 1:
                self.__apply_style_to_button(self.__button_prev)
                self.__apply_style_to_button(self.__button_first)
                self.__apply_style_to_button(self.__button_last, style=stylesheet_for_page_in_pagination, enabled=True,
                                             text=f"{self.__count_pages}")
                self.__apply_style_to_button(self.__button_next, style=stylesheet_for_page_in_pagination, enabled=True,
                                             text=">")
            elif self.__current_page == self.__count_pages:
                self.__apply_style_to_button(self.__button_prev, style=stylesheet_for_page_in_pagination, enabled=True,
                                             text="<")
                self.__apply_style_to_button(self.__button_first, style=stylesheet_for_page_in_pagination,
                                             enabled=True, text="1")
                self.__apply_style_to_button(self.__button_last)
                self.__apply_style_to_button(self.__button_next)
            else:
                ...
                self.__apply_style_to_button(self.__button_last, style=stylesheet_for_page_in_pagination, enabled=True,
                                             text=f"{self.__count_pages}")
                self.__apply_style_to_button(self.__button_current, style=stylesheet_for_active_page_in_pagination,
                                             enabled=True)
        self.__apply_style_to_button(self.__button_current, style=stylesheet_for_active_page_in_pagination,
