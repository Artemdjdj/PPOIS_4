...
class Menu:
    def __init__(self, screen: pygame.Surface) -> None:
        self._screen = screen
        self._buttons = [
            Button(SCREEN_WIDTH // 2 - BUTTON_WIDTH // 2, COORD_Y_FIRST_BUTTON, BUTTON_WIDTH, BUTTON_HEIGHT,
                   BASIC_COLOR,
                   BASIC_BACKGROUND_COLOR, BASIC_BACKGROUND_HOVER_COLOR, NAME_PLAY,
                   pygame.font.Font(BASIC_FONT, BASIC_FONT_SIZE), State.PLAY),
            Button(SCREEN_WIDTH // 2 - BUTTON_WIDTH // 2, COORD_Y_FIRST_BUTTON + HEIGHT_BETWEEN_BUTTONS, BUTTON_WIDTH,
            ...
            Button(SCREEN_WIDTH // 2 - BUTTON_WIDTH // 2, COORD_Y_FIRST_BUTTON + 2 * HEIGHT_BETWEEN_BUTTONS,
                   BUTTON_WIDTH, BUTTON_HEIGHT, BASIC_COLOR,
                   BASIC_BACKGROUND_COLOR, BASIC_BACKGROUND_HOVER_COLOR, NAME_HELP,
                   pygame.font.Font(BASIC_FONT, BASIC_FONT_SIZE), State.HELP),
            Button(SCREEN_WIDTH // 2 - BUTTON_WIDTH // 2, COORD_Y_FIRST_BUTTON + 3 * HEIGHT_BETWEEN_BUTTONS,
                   BUTTON_WIDTH, BUTTON_HEIGHT, BASIC_COLOR,
